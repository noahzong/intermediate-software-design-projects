...
public:
     ...
     */
    [[nodiscard]] const Vector<DIM> add(const Vector<DIM>& rhs) const;

    /**
     *  Returns the additive inverse of this vector.
     */
    [[nodiscard]] const Vector<DIM> invert() const;

    /**
     *  Scales a copy of this vector by rhs and returns the result.
     */
    [[nodiscard]] const Vector<DIM> scale(double rhs) const;

    /**
     *  Returns the dot (inner) product of this vector and rhs.
     */
    [[nodiscard]] double dot(const Vector<DIM>& rhs) const;
